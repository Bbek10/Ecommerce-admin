...
import com.example.kiranapasaadmin.adapter.CategoryAdapter
import com.example.kiranapasaadmin.databinding.FragmentCategoryBinding
import com.example.kiranapasaadmin.databinding.FragmentHomeBinding
...
class CategoryFragment : Fragment() {
    ...
    private fun validateData(categoryName: String) {
        if(categoryName.isEmpty()) {
            Toast.makeText(requireContext(), "Please Provide a category name", Toast.LENGTH_SHORT)
                .show()
